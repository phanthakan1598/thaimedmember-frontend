          ...
          <v-card-text class="py-8 px-md-10 px-4">
            ...
            <v-col cols="12" class="delivery-address">
              ...
              <div class="delivery-address__line">
                ...
                <span>
                  สภาการแพทย์แผนไทย อาคาร 1 ชั้น 14 กรมการแพทย์แผนไทยและการแพทย์ทางเลือก เลขที่ 88/23 หมู่ 4 ต.ตลาดขวัญ อ.เมืองนนทบุรี จ.นนทบุรี 11000
                </span>
              </div>
              <div class="delivery-address__line">
                <v-icon class="delivery-address__icon">
                ...
                <span>
                  โทรศัพท์: 02-580-1157, 02-580-1158, 099-356-1915
                </span>
              </div>
            </v-col>
          </v-card-text>
